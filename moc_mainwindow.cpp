...
#include <memory>
#include "../../ClassPPGenerator/mainwindow.h"
...
QT_MOC_LITERAL(1, 12, 20), // "lancerFenetreGenerer"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "MainFenetre\0lancerFenetreGenerer\0"
};
...
void MainFenetre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainFenetre *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lancerFenetreGenerer(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject MainFenetre::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MainFenetre.data,
    qt_meta_data_MainFenetre,
    qt_static_metacall,
    nullptr,
    nullptr
} };
